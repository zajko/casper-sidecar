// These functions intentionally preserve complete JSON wire fixtures for readability.
...
pub fn legacy_block_added() -> LegacySseData {
    serde_json::from_value(raw_legacy_block_added()).unwrap()
}

pub fn legacy_block_added_from_v2() -> LegacySseData {
    serde_json::from_value(raw_legacy_block_added_from_v2()).unwrap()
}

pub fn block_added_v1() -> SseData {
    serde_json::from_value(raw_block_added_v1()).unwrap()
}

pub fn block_added_v2() -> SseData {
    serde_json::from_value(raw_block_added_v2()).unwrap()
}

pub fn api_version() -> SseData {
    serde_json::from_value(raw_api_version()).unwrap()
}
...
pub fn finality_signature_v1() -> SseData {
    serde_json::from_value(raw_finality_signature_v1()).unwrap()
}

pub fn finality_signature_v2() -> SseData {
    serde_json::from_value(raw_finality_signature_v2()).unwrap()
}

pub fn transaction_accepted() -> SseData {
    serde_json::from_value(raw_transaction_accepted()).unwrap()
}

pub fn deploy_accepted() -> SseData {
    serde_json::from_value(raw_deploy_accepted()).unwrap()
}

pub fn legacy_deploy_accepted() -> LegacySseData {
    serde_json::from_value(raw_legacy_deploy_accepted()).unwrap()
}

pub fn deploy_expired() -> SseData {
    serde_json::from_value(raw_deploy_expired()).unwrap()
}

pub fn transaction_expired() -> SseData {
    serde_json::from_value(raw_transaction_expired()).unwrap()
}

pub fn legacy_deploy_expired() -> LegacySseData {
    serde_json::from_value(raw_legacy_deploy_expired()).unwrap()
}

pub fn legacy_finality_signature() -> LegacySseData {
    serde_json::from_value(raw_legacy_finality_signature()).unwrap()
}

pub fn fault() -> SseData {
    serde_json::from_value(raw_fault()).unwrap()
}

pub fn legacy_fault() -> LegacySseData {
    serde_json::from_value(raw_legacy_fault()).unwrap()
}

pub fn deploy_processed() -> SseData {
    serde_json::from_value(raw_deploy_processed()).unwrap()
}

pub fn legacy_deploy_processed() -> LegacySseData {
    serde_json::from_value(raw_legacy_deploy_processed()).unwrap()
}
...
fn raw_api_version() -> Value {
    json!({
        "ApiVersion": "2.0.0"
    })
}

fn raw_finality_signature_v2() -> Value {
    json!({
        "FinalitySignature": {
            "V2": {
...
fn raw_finality_signature_v1() -> Value {
    json!({
        "FinalitySignature": {
            "V1": {
                "block_hash": "45d7c385cba0a880cbc0068ccc6c58111d057d8190850b744c8e0450a24639d4",
...
fn raw_legacy_finality_signature() -> Value {
    json!({
        "FinalitySignature": {
            "block_hash": "45d7c385cba0a880cbc0068ccc6c58111d057d8190850b744c8e0450a24639d4",
            "era_id": 139,
...
fn raw_transaction_accepted() -> Value {
    json!({
        "TransactionAccepted": {
            "Version1": {
...
fn raw_legacy_deploy_accepted() -> Value {
    json!({
        "DeployAccepted": {
...
fn raw_transaction_expired() -> Value {
    json!({
        "TransactionExpired": {
            "transaction_hash": {
...
fn raw_legacy_deploy_expired() -> Value {
    json!({
        "DeployExpired": {
...
fn raw_legacy_block_added() -> Value {
    json!({
        "BlockAdded": {
                ...
                "Version2": {
                    ...
                    "header": {
                        ...
                        "era_end": {
                            ...
                            "rewards": {
                                "02028b18c949d849b377988ea5191b39340975db25f8b80f37cc829c9f79dbfb19fc": [
                                    "749546792"
                                ],
                                "02028002c063228ff4e9d22d69154c499b86a4f7fdbf1d1e20f168b62da537af64c2": [
                                    "788342677"
                                ],
                                "02038efa405f648c72f36b0e5f37db69ab213d44404591b24de21383d8cc161101ec": [
                                    "86241635"
                                ],
                                "01f6bbd4a6fd10534290c58edb6090723d481cea444a8e8f70458e5136ea8c733c": [
                                    "941794198"
                                ]
                            },
                    ...
                    "body": {
                        "transactions": {
                            ...
                            "1": [
                                {
                                    "Deploy": "58aca0009fc41bd045d303db9e9f07416ff1fd8c76ecd98545eedf86f9459e82"
                                },
                                {
                            ...
                            "2": [
                                ...
                                {
                                    "Deploy": "58aca0009fc41bd045d303db9e9f07416ff1fd8c76ecd98545eedf86f9459e85"
                                },
                                {
                                    "Version1": "58aca0009fc41bd045d303db9e9f07416ff1fd8c76ecd98545eedf86f9459e92"
                                }
                            ],
                            "3": [
                                {
                                ...
                                {
                                    "Version1": "58aca0009fc41bd045d303db9e9f07416ff1fd8c76ecd98545eedf86f9459e93"
                                }
                            ]
                        },
                        "rewarded_signatures": [
...
fn raw_legacy_block_added_from_v2() -> Value {
    json!({
        "BlockAdded": {
            "block_hash": "2df9fb8909443fba928ed0536a79780cdb4557d0c05fdf762a1fd61141121422",
            "block": {
            ...
            "messages": [
                {
                    ...
                    "topic_index": 2222189259_u32,
                    "block_index": 11650550294672125610_u64
                }
            ]
        }
    })
...
fn raw_legacy_deploy_processed() -> Value {
    json!({
        "DeployProcessed": {
